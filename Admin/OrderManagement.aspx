...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:SqlDataSource ID="ActiveOrdersSource" runat="server" ConnectionString="<%$ ConnectionStrings:KtradeConnectionString %>"
        SelectCommand="        
            select
                O.Customer_id,
                O.id as id,
                MAX (C.FirstName) + ' ' + MAX (C.LastName) as CustomerName,
            ...
            from
                ...
                join Customers as C with (nolock) on C.Customer_id = O.Customer_id
            ...
            group by
                ...
                O.OrderStatus
            having
				'*' + ' ' + convert(nvarchar(15), O.id) + ' ' + MAX (C.FirstName) + ' ' + MAX (C.LastName) + ' ' + convert(nvarchar(15), MAX (O.CreationDate)) like '%*%'
            order by
                O.id"
    ...
    <asp:SqlDataSource ID="OrderStatusesSource" runat="server" ConnectionString="<%$ ConnectionStrings:KtradeConnectionString %>" SelectCommand="SELECT Status_id, StatusDescription FROM [OrderStatuses]"></asp:SqlDataSource>
            ...
            <asp:GridView ID="ActiveOrdersGridView" runat="server" GridLines="None"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Действия">
                        ...
                        <ItemTemplate>
                            <asp:ImageButton ID="ExportButton" runat="server" CommandName="GetCSV" CommandArgument='<%# Bind("id") %>' ImageUrl="~/Images/Buttons/SaveKatorg16.png" Title="Экспорт для KATORG" />
    ...
    <div class="download">
        <p>Выгрузить все:</p>
        <asp:ImageButton ID="KatorgExportTotalButton" runat="server" ImageUrl="~/Images/Buttons/SaveKatorgTotal.png" Title="Экспорт для KATORG" onclick="KatorgExportTotalButton_Click" />
    ...
    <div class="download">
        <p>Выгрузить новое:</p>
        <asp:ImageButton ID="KatorgExportNewButton" runat="server" ImageUrl="~/Images/Buttons/SaveKatorgTotal.png" Title="Экспорт для KATORG" onclick="KatorgExportNewButton_Click" />
