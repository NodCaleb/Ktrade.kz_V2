...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>Ktrade_Admin - покупатели</title>
    <link rel="Stylesheet" href="../css/Dictionary.css" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:SqlDataSource ID="CustomerListSource" runat="server" ConnectionString="<%$ ConnectionStrings:KtradeConnectionString %>" SelectCommand="select UserId, FullName from UserView order by FullName asc"></asp:SqlDataSource>
    <asp:SqlDataSource ID="CustomerDetailsSource" runat="server" ConnectionString="<%$ ConnectionStrings:KtradeConnectionString %>"
        SelectCommand="select UserID, Customer_id, FirstName, LastName, Alias, Email, UserName, Password, IsLockedOut from UserView where UserId = @UserId"
