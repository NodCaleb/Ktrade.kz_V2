...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>Ktrade_Admin - новости</title>
    <link rel="Stylesheet" href="../css/Dictionary.css" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:SqlDataSource ID="NewsListSource" runat="server" ConnectionString="<%$ ConnectionStrings:KtradeConnectionString %>"
    ...
    <asp:SqlDataSource ID="NewsDetailsSource" runat="server" ConnectionString="<%$ ConnectionStrings:KtradeConnectionString %>"
        DeleteCommand="DELETE FROM [News] WHERE [id] = @id"
        InsertCommand="INSERT INTO [News] ([Header], [Body], [Published],[Teaser]) VALUES (@Header, @Body, @Published, @Teaser)"
        SelectCommand="SELECT [id], [Header], [Body], isnull([Published],0) as Published, [CreationDate], isnull([Teaser],'...') as Teaser FROM [News] WHERE [id] = @id"
        UpdateCommand="UPDATE [News] SET [Header] = @Header, [Body] = @Body, [Published] = @Published, [CreationDate] = @CreationDate, [Teaser] = @Teaser WHERE [id] = @id">
        <DeleteParameters>
    ...
    <asp:SqlDataSource ID="TagsListSource" runat="server" ConnectionString="<%$ ConnectionStrings:KtradeConnectionString %>"
        SelectCommand=" select
	                    id,
	                    Tag
                        from
    ...
    <asp:SqlDataSource ID="CurrentTagsSource" runat="server" ConnectionString="<%$ ConnectionStrings:KtradeConnectionString %>"
        SelectCommand=" select
	                    T.id,
	                    T.Tag
                        from
	...
	<asp:UpdatePanel ID="TagsUpdatePanel" runat="server" UpdateMode="Conditional">
        ...
        <p>&lt;p class="orderbutton"&gt;&lt;a href="http://ktrade.kz/Customer/NewOrder.aspx?catalogue=<b>№каталога</b>&article=<b>артикул</b>&name=<b>наименование</b>&price=<b>цена</b>&size=<b>размер</b>&color=<b>цвет</b>&URL=<b>ссылка</b>"&gt;&lt;img alt="" src="Images/OrderButton.png" title="Заказать" /&gt;&lt;/a&gt;&lt;p&gt;</p>
