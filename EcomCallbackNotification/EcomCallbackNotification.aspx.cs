...
public partial class EcomCallbackNotification : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!String.IsNullOrEmpty(authorizationHeader))
        {
            ...
            if (username != "196" || password != "cbd1e4a3759aa8a3d6278b444af636004b38be619d2b159d4cd325da5f64cddf")
            {
                return;
            }
            ...
            KtradeConnection.Open();
            SqlTransaction tran=KtradeConnection.BeginTransaction();
            try
            {               
