...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"> 
    <asp:Panel ID="PopularCataloguesPanel" runat="server" Visible="False">
        <asp:SqlDataSource ID="PopularCataloguesSource" runat="server" ConnectionString="<%$ ConnectionStrings:KtradeConnectionString %>"
    ...
    <asp:SqlDataSource ID="CataloguesSource" runat="server" ConnectionString="<%$ ConnectionStrings:KtradeConnectionString %>"
