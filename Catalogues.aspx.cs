...
public partial class Catalogues : System.Web.UI.Page
{
    ...
    SqlCommand GetPopularCount = new SqlCommand(GetPopularCountString, KtradeConnection);
    ...
    {
        Page.Header.Title = "Ktrade - каталоги товаров";
        ...
        if (Request.QueryString["Tag"] != null)
        {
            ...
            Page.Header.Title = "Ktrade - каталоги товаров" + GetCategoryNameByTag(Request.QueryString["Tag"].ToString());
