<%@ Page Title="" Language="C#" MasterPageFile="~/SideModulesDefault.master" AutoEventWireup="true" CodeFile="PaymentFail.aspx.cs" Inherits="Admin_OrderManagement" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>Ktrade - платеж не прошел</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<p>Если вы уверены, что все сделали правильно, пожалуйста, сообщите мне об этом: <a href="mailto:admin@ktrade.kz">admin@ktrade.kz</a>.</p>
