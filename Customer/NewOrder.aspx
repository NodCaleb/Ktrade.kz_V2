<%@ Page Title="" Language="C#" MasterPageFile="~/SideModulesOrders.master" AutoEventWireup="true" CodeFile="NewOrder.aspx.cs" Inherits="Customer_NewOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p>Внимание, размеры на немецких каталогах указаны немецкие! <a href="../Infos/Groessen.aspx">Таблица размеров</a> представлена тут. Просим вас ознакомится с ней или проконсультироваться по телефону.</p>
