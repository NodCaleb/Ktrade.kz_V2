...
public partial class Customer_MyWishList : System.Web.UI.Page
{
    ...
    SqlCommand FullfillWish = new SqlCommand(FullfillWishString, KtradeConnection);
    public static int MinPrice = 7;
    public static string ShareLink;// = "http://ktrade.kz/WishListView.aspx?customer=";
	...
	ShareLink = "http://ktrade.kz/WishListView.aspx?customer=";
	...
	SmtpClient KtradeSMTP = new SmtpClient();
        ...
        MailAddress Office = new MailAddress("office@ktrade.kz", "Ktrade");
