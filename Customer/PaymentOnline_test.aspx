<%@ Page Title="" Language="C#" MasterPageFile="~/SideModulesOrders.master" AutoEventWireup="true" CodeFile="PaymentOnline_test.aspx.cs" Inherits="Admin_OrderManagement" %>
            ...
            <tr>
                <td style="direction: ltr; text-align: left">
                    <asp:radiobuttonlist id="MethodsList" runat="server" style="direction: ltr" align="left">
                        <asp:ListItem>
					        Электронные деньги: WebMoney, Яндекс.Деньги и т.п.
                        </asp:ListItem>
                        <asp:ListItem>
					        Платежная система WOOPPAY (да, есть и такая)
                        </asp:ListItem>
                        <asp:ListItem>
