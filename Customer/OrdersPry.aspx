<%@ Page Title="" Language="C#" MasterPageFile="~/SideModulesOrders.master" AutoEventWireup="true" CodeFile="OrdersPry.aspx.cs" Inherits="Admin_OrderManagement" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>Ktrade - что заказывают люди...</title>
    <link rel="Stylesheet" href="../css/Admin.css" />
    <link rel="Stylesheet" href="../css/Pry.css" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	<asp:SqlDataSource ID="PrySource" runat="server" ConnectionString="<%$ ConnectionStrings:KtradeConnectionString %>"
        SelectCommand="select top 50
						  dbo.TimePassed (OI.CreationDate) as [TimePassed],
						  'http://ktrade.kz/Images/Logos/' +  C.ImageLink as [ImageLink],
						  C.CatalogueName,
						  left (OI.ArticleName, 25) as ArticleName,
						  OI.Price,
						  OI.Comment,
						  'http://ktrade.kz/Customer/NewOrder.aspx?catalogue='+ convert (nvarchar(5), OI.Catalogue_id) + '&article=' + OI.Article_id + '&name=' + OI.ArticleName +'&price=' + REPLACE (convert(nvarchar(10),OI.Price), '.', ',') + '&size=' + OI.Size + '&color=' + OI.Colour + '&URL=' + REPLACE (OI.Comment, 'http://', '') as OrderURL   
						from
						  OrderItems as OI
	...
	<asp:ScriptManager ID="PryScriptManager" runat="server"></asp:ScriptManager>
	<asp:Timer ID="UpdateTimer" runat="server" OnTick="UpdateTimer_Tick" Interval="60000" Enabled="True"></asp:Timer>
	<h2>Последние 50 заказов на сайте:</h2>
