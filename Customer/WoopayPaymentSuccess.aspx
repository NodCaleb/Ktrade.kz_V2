<%@ Page Title="" Language="C#" MasterPageFile="~/SideModulesDefault.master" AutoEventWireup="true" CodeFile="WoopayPaymentSuccess.aspx.cs" Inherits="Admin_OrderManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<asp:Panel id="NoPaymentPanel" runat="server">
		...
		<p>Это не страшно, у нас все найдется. Если вы видите это сообщение, пожалуйста, напишите мне об этом: <a href="mailto:admin@ktrade.kz">admin@ktrade.kz</a>.</p>
