<%@ Page Title="" Language="C#" MasterPageFile="~/SideModulesDefault.master" AutoEventWireup="true" CodeFile="ChangePassword.aspx.cs" Inherits="Customer_ChangePassword" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>Ktrade - смена пароля</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:ChangePassword ID="KtradeChangePassword" CancelDestinationPageUrl="~/" runat="server">
        ...
        <MailDefinition From="admin@ktrade.kz" Subject="Смена пароля Ktrade.kz" BodyFileName="~/Customer/ChangePassword.txt" />
    </asp:ChangePassword>
</asp:Content>
