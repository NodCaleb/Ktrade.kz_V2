<%@ Page Title="" Language="C#" MasterPageFile="~/SideModulesOrders.master" AutoEventWireup="true" CodeFile="MyWishList.aspx.cs" Inherits="Customer_MyWishList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<div ID="yasharediv" runat="server" class="yashare-auto-init" data-yashareL10n="ru" data-yashareType="button" data-yashareImage="http://ktrade.kz/images/list.png" data-yasharedescription="Список того, что я хочу получить в подарок." data-yashareLink="http://ktrade.kz" data-yashareQuickServices="vkontakte,facebook,twitter,odnoklassniki,moimir"></div>
